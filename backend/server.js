...
//store the user’s ID in a token, sign it, and send it to the frontend by  creating JWT
...
// we will create REST endpoint with the paths
...
//validation of the JWT in every frontend request
